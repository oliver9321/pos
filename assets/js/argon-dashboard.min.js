"use strict";
! function () {
    var e, t;  (document.getElementsByClassName("main-content")[0] && (e = document.querySelector(".main-content"), new PerfectScrollbar(e)), document.getElementsByClassName("sidenav")[0] && (e = document.querySelector(".sidenav"), new PerfectScrollbar(e,{handlers : ['wheel', 'touch'],wheelPropagation: false,swipeEasing : true})), document.getElementsByClassName("navbar-collapse")[0] && (t = document.querySelector(".navbar-collapse"), new PerfectScrollbar(t)), document.getElementsByClassName("fixed-plugin")[0] && (t = document.querySelector(".fixed-plugin"), new PerfectScrollbar(t)))
    document.getElementsByClassName("sidenav")[0].addEventListener('touchstart', (ez) => {
        document.body.classList.add('prevent-scroll')
    });
    document.getElementsByClassName("sidenav")[0].addEventListener('touchend', (ez) => {
...
function sidebarType(e) {
    ...
    "bg-white" == a && i ? (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.html") && (c = o.replace("logo-ct", "logo-ct-dark"), r.src = c) : (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct-dark.html") && (c = o.replace("logo-ct-dark", "logo-ct"), r.src = c), "bg-white" == a && n && (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.html") && (c = o.replace("logo-ct", "logo-ct-dark"), r.src = c)
}
...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        t.classList.remove("dark-version"), n.classList.add("bg-white"), x.includes("logo-ct.html") && (q = x.replace("logo-ct", "logo-ct-dark"), w.src = q);
        ...
        var q;
        t.classList.add("dark-version"), x.includes("logo-ct-dark.html") && (q = x.replace("logo-ct-dark", "logo-ct"), w.src = q);
